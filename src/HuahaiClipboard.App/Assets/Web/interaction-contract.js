(function (global, factory) {
  ...
  const staticControls = Object.freeze({
    'panel.search': '#searchInput', 'panel.minimize': '#minimizeButton', 'panel.settings': '#settingsButton', 'panel.update-later': '#updateBannerLater', 'panel.update-install': '#updateBannerInstall', 'panel.summon': '#summonButton', 'records.scroll': '#recordList', 'panel.autohide': '#autoHide', 'panel.drag': '.panel-header',
