...
& 'C:\Program Files (x86)\Microsoft Visual Studio\2022\BuildTools\MSBuild\Current\Bin\MSBuild.exe' `
  ...
  /p:RuntimeIdentifier=win-x64 /p:SelfContained=false /p:WindowsAppSDKSelfContained=true /p:Version=1.1.9 `
  /p:OutDir="$PWD\dist\webview-build-1.1.9\" /restore /m

.\installer\Fetch-Prerequisites.ps1 -Destination dist\prerequisites
.\installer\Build-Installer.ps1 `
  -PublishRoot dist\webview-build-1.1.9 `
